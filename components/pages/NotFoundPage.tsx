      ...
      <div className="pt-28 pb-16 bg-white min-h-screen flex items-center justify-center">
        <div className="max-w-2xl mx-auto px-5 text-center">
          ...
          <p className="text-[16px] sm:text-[18px] text-slate-600 leading-relaxed mb-10">
            A página que você tentou acessar não existe ou foi movida. Nossa equipe técnica está online para ajudar você agora mesmo.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a
              ...
              onClick={(e) => handleTrackedWhatsAppClick({ location: 'page_404_whatsapp', message: BUSINESS_CONFIG.whatsapp.messages.floating, event: e })}
              target="_blank"
