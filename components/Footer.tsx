...
import { MapPin, Instagram, Facebook, Phone, Mail, Star } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-1">
            ...
            <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 px-3 py-1.5 rounded-lg">
              ...
              <span className="text-[8px] font-black uppercase tracking-widest text-blue-200">A Mais Recomendada</span>
            </div>
          </div>
